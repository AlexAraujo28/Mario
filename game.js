 ...
 * SPRITES
 ***********************************************************************/
function __MarioRight() { 
__sprite_init__(this, MarioRight, 64, 64, 0, 0, 'Box', 32, 0, 64, 0, 64, ['img/MarioRight_1.png','img/MarioRight_2.png','img/MarioRight_3.png']);
}; var MarioRight = new __MarioRight();

function __MarioLeft() { 
__sprite_init__(this, MarioLeft, 64, 64, 0, 0, 'Box', 32, 0, 64, 0, 64, ['img/MarioLeft_0.png','img/MarioLeft_1.png','img/MarioLeft_2.png']);
}; var MarioLeft = new __MarioLeft();

function __marioStillR() { 
__sprite_init__(this, marioStillR, 64, 64, 0, 0, 'Box', 32, 0, 64, 0, 64, ['img/marioStillR_0.png']);
}; var marioStillR = new __marioStillR();

function __MarioStillL() { 
__sprite_init__(this, MarioStillL, 64, 64, 0, 0, 'Box', 32, 0, 64, 0, 64, ['img/MarioStillL_0.png']);
}; var MarioStillL = new __MarioStillL();
 ...
 * OBJECTS
 ***********************************************************************/
function __MarioROBJ() {
__instance_init__(this, MarioROBJ, null, 1, 0, MarioRight, 1, 0);
...
{
	instance_destroy();
	instance_create(xprevious,yprevious,MarioOBJSTILLR);
...
}; var MarioROBJ = new __MarioROBJ();

function __MarioLOBJ() {
__instance_init__(this, MarioLOBJ, null, 1, 0, MarioLeft, 1, 1);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
...
if(keyboard_check_released(vk_left))
{
	...
	instance_destroy();
	instance_create(xprevious,yprevious,MarioOBJSTILLL);
}
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var MarioLOBJ = new __MarioLOBJ();

function __MarioOBJSTILLR() {
__instance_init__(this, MarioOBJSTILLR, null, 1, 0, marioStillR, 1, 2);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
...
{
	instance_destroy();
	instance_create(xprevious,yprevious,MarioROBJ);
}
if(keyboard_check(vk_left))
{
	instance_destroy();
	instance_create(xprevious,yprevious,MarioLOBJ);
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var MarioOBJSTILLR = new __MarioOBJSTILLR();

function __MarioOBJSTILLL() {
__instance_init__(this, MarioOBJSTILLL, null, 1, 0, MarioStillL, 1, 3);
this.on_creation = on_creation_i;
this.on_destroy = on_destroy_i;
this.on_step = function() {
with(this) {
...
this.on_animationend = on_animationend_i;
this.on_draw = on_draw_i;
}; var MarioOBJSTILLL = new __MarioOBJSTILLL();
...
this.objects = [
[{o:MarioOBJSTILLR, x:20, y:400}]];
this.start = function() {
__room_start__(this, scene_6, 640, 480, 30, 0, 0, 0, null, 0, 0, 0, 640, 480, null, 50, 50);
};
}
var scene_6 = new __scene_6();
tu_scenes.push(scene_6);
tu_room_to_go = scene_6;
